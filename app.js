...
var createNewTaskElement=function(taskString){
    ...
    listItem.classList.add("list__item", "task");
    ...
    editButton.classList.add("button", "task__button", "task__button--edit");

    deleteButton.classList.add("button", "task__button", "task__button--delete");
    deleteButtonImg.classList.add("task__button-img");
